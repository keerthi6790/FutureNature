      ...
      <div className={styles.modal}>
        ...
        {step === "PHONE" && (
          <div className={styles.formGroup}>
            ...
            <button onClick={triggerOtp} className={styles.submitButton}>
              Send OTP
            </button>
          </div>
        )}
        ...
        {step === "OTP" && (
          <div className={styles.formGroup}>
            ...
            <button onClick={verifyOtp} className={styles.submitButton}>
              Verify & Login
            </button>
            <p className={styles.changeNumberText}>
              {canResend ? (
                <button onClick={triggerOtp} className={styles.resendButton}>
                  Resend OTP
                </button>
              ) : (
