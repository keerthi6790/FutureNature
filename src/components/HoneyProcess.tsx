  ...
  return (
    <div className={styles.processSection}>
      ...
      <div className={styles.sectionHeader}>
        ...
        <h2 className={styles.title}>From <span className={styles.highlight}>Hive</span> to Home</h2>
        <p className={styles.subTitle}>A journey of purity, patience, and passion.</p>
      </div>
      ...
      <div className={styles.timelineContainer}>
        ...
        {processes.map((item, index) => {
          ...
          return (
            <div key={item.id} className={`${styles.timelineRow} ${isEven ? styles.reverse : ''}`}>
