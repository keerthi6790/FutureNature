      ...
      icon: (
        ...
        >
          <g clipPath="url(#clip0_8_422)">
            <path
              d="M14.375 1.4375H23V8.81188C23 9.14356 22.8682 9.46166 22.6337 9.6962C22.3992 9.93074 22.0811 10.0625 21.7494 10.0625H15.6256C15.2939 10.0625 14.9758 9.93074 14.7413 9.6962C14.5068 9.46166 14.375 9.14356 14.375 8.81188V1.4375Z"
              fill="#FBBF24"
            />
            <path
            ...
            />
            <path
              d="M33.0625 46C30.5037 46 28.0024 45.2412 25.8748 43.8196C23.7473 42.3981 22.089 40.3775 21.1098 38.0135C20.1306 35.6495 19.8744 33.0482 20.3736 30.5385C20.8728 28.0289 22.105 25.7237 23.9143 23.9143C25.7237 22.105 28.0289 20.8728 30.5385 20.3736C33.0482 19.8744 35.6495 20.1306 38.0135 21.1098C40.3775 22.089 42.3981 23.7473 43.8196 25.8748C45.2412 28.0024 46 30.5037 46 33.0625C46 36.4937 44.637 39.7844 42.2107 42.2107C39.7844 44.637 36.4937 46 33.0625 46ZM33.0625 23C31.0723 23 29.1268 23.5902 27.4721 24.6958C25.8173 25.8015 24.5276 27.3731 23.766 29.2118C23.0044 31.0504 22.8051 33.0737 23.1934 35.0256C23.5816 36.9775 24.54 38.7705 25.9472 40.1778C27.3545 41.585 29.1475 42.5434 31.0994 42.9317C33.0513 43.3199 35.0746 43.1207 36.9133 42.359C38.7519 41.5974 40.3235 40.3077 41.4292 38.6529C42.5349 36.9982 43.125 35.0527 43.125 33.0625C43.125 30.3938 42.0649 27.8343 40.1778 25.9472C38.2907 24.0602 35.7312 23 33.0625 23Z"
              fill="#373737"
            />
            <path
              d="M33.0625 40.25C37.032 40.25 40.25 37.032 40.25 33.0625C40.25 29.093 37.032 25.875 33.0625 25.875C29.093 25.875 25.875 29.093 25.875 33.0625C25.875 37.032 29.093 40.25 33.0625 40.25Z"
              fill="#FBBF24"
            />
            <path
              d="M35.9375 31.625H34.5V30.1875C34.5 29.8063 34.3486 29.4406 34.079 29.171C33.8094 28.9014 33.4437 28.75 33.0625 28.75C32.6813 28.75 32.3156 28.9014 32.046 29.171C31.7764 29.4406 31.625 29.8063 31.625 30.1875V31.625H30.1875C29.8063 31.625 29.4406 31.7764 29.171 32.046C28.9014 32.3156 28.75 32.6813 28.75 33.0625C28.75 33.4437 28.9014 33.8094 29.171 34.079C29.4406 34.3486 29.8063 34.5 30.1875 34.5H31.625V35.9375C31.625 36.3187 31.7764 36.6844 32.046 36.954C32.3156 37.2236 32.6813 37.375 33.0625 37.375C33.4437 37.375 33.8094 37.2236 34.079 36.954C34.3486 36.6844 34.5 36.3187 34.5 35.9375V34.5H35.9375C36.3187 34.5 36.6844 34.3486 36.954 34.079C37.2236 33.8094 37.375 33.4437 37.375 33.0625C37.375 32.6813 37.2236 32.3156 36.954 32.046C36.6844 31.7764 36.3187 31.625 35.9375 31.625Z"
              fill="#373737"
            />
          </g>
          <defs>
    ...
    <>
      ...
      >
        ...
        >
          ...
          <p
            style={{ fontSize: "14px", color: "#6b7280", marginBottom: "28px" }}
          >
              ...
              {ALL_PRODUCTS.map((deal) => (
                <label
                  ...
                  style={{
                    ...
                    padding: "12px",
                    borderRadius: "10px",
                    backgroundColor: selectedDealIds.includes(deal.id)
                      ? "#fffbeb"
                      : "#f9fafb",
