  ...
  return (
    <div className={styles.pageWrapper}>
      <Head>
        ...
        <meta
          name="description"
          content="View and track all your orders from FutureNature"
        />
      </Head>
      <Navbar />
              ...
              >
                <div className={styles.orderHeader}>
                  ...
                  <div className={styles.orderMeta}>
                    <span
                      className={`${styles.statusBadge} ${getStatusClass(order.paymentStatus)}`}
                    >
                      {order.paymentStatus}
                    </span>
                ...
                <div className={styles.orderItems}>
                  {order.items.slice(0, 5).map((item) => (
                    <div key={item.id} className={styles.itemPreview}>
                      <img
                        src={
                          item.product.imageUrl[0] || "/Assets/Products/15.png"
                        }
